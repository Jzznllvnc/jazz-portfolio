  ...
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
    ...
    <div style="padding: 30px;">
      ...
      <div style="background-color: #f9f9f9; padding: 20px; border-radius: 6px; margin-bottom: 25px;">
        ...
        <div style="margin-top: 10px; padding: 15px; background-color: white; border-radius: 4px; border-left: 3px solid #00fffb;">
          ${message}
        </div>
      </div>
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
    <div style="max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 30px; background-color: #ffffff;">
            ...
            <p style="font-size: 16px; color: #333333; margin: 0 0 15px 0;">Thank you for contacting me through my portfolio website. I've received your message and will review it shortly.</p>
            <p style="font-size: 16px; color: #333333; margin: 0 0 25px 0;">I typically respond within 24-48 hours, and I'll get back to you as soon as possible.</p>
            
            <div style="margin: 30px 0; text-align: center;">
                <div style="display: inline-block; padding: 15px 25px; background-color: #f8f8f8; border-radius: 6px; border-left: 4px solid #00fffb;">
