...
const slateLiveUrl = 'https://logistic1.slatefreight-ph.com/';
const slateLiveGlowStyle = {
              ...
              >
                ...
                <span aria-hidden="true" className="absolute inset-0 rounded-full overflow-hidden">
                  <span
                    ...
                    style={slateLiveGlowStyle}
                  />
                </span>
                <span className="relative z-10 m-[3px] inline-flex items-center justify-center rounded-full bg-black px-8 py-3 text-sm font-medium uppercase tracking-[0.26em] text-white">
                  View it live
                </span>
              </a>
            </div>
